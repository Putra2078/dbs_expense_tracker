                                        ...
                                        <tbody>
                                            ...
                                            try {
                                                ...
                                                foreach ($incomes as $income) {
                                                    echo "<tr>";
                                                    echo "<td>" . $no++ . "</td>";
                                                    echo "<td>" . htmlspecialchars(formatTanggal($income['date'])) . "</td>";
                                                    echo "<td>" . htmlspecialchars($income['category']) . "</td>";
                                                    echo "<td>" . htmlspecialchars($income['notes']) . "</td>";
                                                    echo "<td>" . htmlspecialchars($income['descriptions']) . "</td>";
                                                    echo "<td>" . formatRupiah($income['amount']) . "</td>";
                                                    echo "</tr>";
                                                }
